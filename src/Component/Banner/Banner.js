        ...
        <div className="container">
            <div className="row banner pt-2 d-flex">
                <div className="col-md-6  col-sm-12">
                    ...
                    <p className="fw-bold pb-3" style={{color:"rgb(44 51 100 / 88%)"}}>No matter who you’re looking to travel with, you can depend on our 2,500 trusted operators to make sure everything’s taken care of.</p>
                    <Link  as={HashLink}
                    to="/campBlog"
